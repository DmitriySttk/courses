...
import javase.task6.robots.enums.RobotBody;
import javase.task6.robots.enums.RobotHead;
import javase.task6.robots.interfaces.FinishedBody;
...
public class RobotsFactory extends Roll implements FinishedBody {
    ...
    class HeadFactory implements javase.task6.robots.interfaces.FinishedHead {
